...
- ROBOMIMIC Can DIPO seed42 formal fine-tuning: **COMPLETE**; see `reports/FIG4_ROBOMIMIC_CAN_DIPO_SEED42.md` and the uploaded CSV/curves.
...
The Can DPPO, IDQL, and DIPO results and the three-method comparison are
